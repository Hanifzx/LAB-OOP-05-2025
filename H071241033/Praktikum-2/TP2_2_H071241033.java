...
public class TP2_2_H071241033 {
    public static void main (String[] args) {
        ...
        ProductInformation product3 = new ProductInformation(10025, "Video Prabowo Mandi Bareng Anis Divideoin Ganjar", 1, 193700000);
        ...
        if (answer.equalsIgnoreCase("yes")) {
            System.out.println(product3.getAvailability() ? "*Product is available" : "*Product is not available (Pake nanya)");
        } else {
            System.out.println("\n*OK, have a nice day!");
        }
        scanner.close();
